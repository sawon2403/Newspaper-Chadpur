        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                 ...
                 @include('front-end.welcome.post-category.jatio')
                    <!-- antarjatik news publish section-->
                  @include('front-end.welcome.post-category.antarjatik')
                </div>

                <!-- lastest news will be publish here-->
                @include('front-end.partials.latest_news')
                @include('front-end.welcome.post-category.add')
        </div>
    </div>
    <!--    Chadpur section post will publish here-->
   @include('front-end.welcome.post-category.cadpur')
    <!--    Chadpur section post will publish here-->
    @include('front-end.welcome.post-category.rajniti')
    <!--    binodon.blade.php and rajnoitik post area-->
    <div class="binodon-khela">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                   @include('front-end.welcome.post-category.khela')

                </div>
                <div class="col-md-6">
                   @include('front-end.welcome.post-category.binodon')
                </div>
            </div>
        </div>
    </div>
    <!--    motamot.blade.php section post-->
    @include('front-end.welcome.post-category.motamot')
    <!--    onnanno section-->
    <div class="onnanno">
        <div class="container">
            <div class="row no-gutters">
                @include('front-end.welcome.post-category.islam')
                @include('front-end.welcome.post-category.crime')
                @include('front-end.welcome.post-category.interview')
                @include('front-end.welcome.post-category.helth')
            </div>
        </div>
    </div>
@stop
