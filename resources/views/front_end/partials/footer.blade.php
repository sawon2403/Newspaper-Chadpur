            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="footer-menu">
                        <ul>
                            <li><a href="{{('/')}}">হোম</a></li>
                            <li><a href="{{('/jatio')}}">জাতীয়</a></li>
                            <li><a href="{{('/antarjatik')}}">আন্তর্জাতিক</a></li>
...
<script>
    $("#showmenu").click(function() {
        $(".toggle-megamenu").show(500);
    });
    $("#menuhide").click(function() {
        $(".toggle-megamenu").hide(500);
    });
