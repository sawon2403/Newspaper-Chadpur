                ...
                <div class="col-md-6">
                    ...
                    <div class="initial-post">
                        <div class="news-image">
                            <a href=""><img class="img-fluid img-thumbnail change-color" src="{{asset('assets/front_end/image/')}}/aa.jpg" alt=""></a>
                        </div>
                    ...
                    <div class="container-fluid p-none ">
                        <div class="flex-post">
                            <div class="row no-gutters">
                                <div class="col-md-5"><img class="img-fluid" src="{{asset('assets/front_end/image/')}}/bb.jpg" alt=""></div>
                        ...
                        <div style="margin-top: 10px" class="flex-post">
                            <div class="row no-gutters">
                                <div class="col-md-5"><img class="img-fluid" src="{{asset('assets/front_end/image/')}}/aa.jpg" alt=""></div>
                                <div class="col-md-7 "><a href="">হাজীগঞ্জে রোটারী ক্লাব অব উত্তরা’র কম্পিউটার বিতরণ</a></div>
                        ...
                        <div style="margin-top: 10px" class="flex-post">
                            <div class="row no-gutters">
                                <div class="col-md-5"><img class="img-fluid" src="{{asset('assets/front_end/image/')}}/cc.jpg" alt=""></div>
                                <div class="col-md-7 "><a href="">হাজীগঞ্জে রোটারী ক্লাব অব উত্তরা’র কম্পিউটার বিতরণ</a></div>
                                <!--post link should be inserted bellow in href-->
                                <a href="#" class="link-overlay"></a>
                            </div>
                        ...
                        <div style="margin-top: 10px" class="flex-post">
                            <div class="row no-gutters">
                                <div class="col-md-5"><img class="img-fluid" src="{{asset('assets/front_end/image/')}}/s.jpg" alt=""></div>
                                <div class="col-md-7 "><a href="">হাজীগঞ্জে রোটারী ক্লাব অব উত্তরা’র কম্পিউটার বিতরণ</a></div>
                                <!--post link should be inserted bellow in href-->
                                <a href="#" class="link-overlay"></a>
                            </div>
